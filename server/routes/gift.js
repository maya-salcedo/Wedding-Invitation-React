...
router.get('/', function (req, res, next) {
  if (req.query.it) {
    return res.json({
      title: 'Regali',
      message:
        'La vostra presenza al nostro matrimonio è il dono più grande tutti. Se desideri farci un regalo, apprezzeremmo molto un contributo per la nostra luna di miele.',
      account: {
